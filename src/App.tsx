...
const App = () => {
  ...
  // 100% FINISHED DEMO DATA WITH COMPLETE BREAKDOWN
  const loadDemoData = async () => { if (!user) return; setIsSyncing(true); const end = new Date(); const start = new Date(); start.setMonth(start.getMonth() - 6); 
    ...
    const materialsDemo: Material[] = [
        ...
        { id: 3, name: 'Bata Merah', unit: 'Pcs', stock: 5000, minStock: 1000 },
        { id: 4, name: 'Besi Beton 10mm', unit: 'Batang', stock: 100, minStock: 30 },
        { id: 5, name: 'Granit 60x60', unit: 'Dus', stock: 20, minStock: 10 },
        { id: 6, name: 'Cat Tembok Dulux', unit: 'Pail', stock: 5, minStock: 2 }
    ];

    const workersDemo: Worker[] = [
        ...
        { id: 3, name: 'Mas Joko', role: 'Tukang', realRate: 170000, mandorRate: 200000, wageUnit: 'Harian' },
        { id: 4, name: 'Kang Asep', role: 'Kenek', realRate: 120000, mandorRate: 140000, wageUnit: 'Harian' },
        { id: 5, name: 'Dani', role: 'Kenek', realRate: 120000, mandorRate: 140000, wageUnit: 'Harian' }
    ];
    ...
    transactions: [
      ...
      { id: 204, date: d(3), category: 'Upah Tukang', description: 'Gaji Bulan 3', amount: 100000000, type: 'expense' },
    ...
    taskLogs: [
        ...
        {id:3, date:d(2), taskId:5, previousProgress:0, newProgress:100, note:'Beton Selesai'},
        {id:4, date:d(3), taskId:6, previousProgress:0, newProgress:100, note:'Atap Selesai'},
        {id:5, date:d(4), taskId:7, previousProgress:0, newProgress:100, note:'Dinding Selesai'},
        {id:6, date:d(5), taskId:8, previousProgress:0, newProgress:100, note:'Lantai Selesai'},
        {id:7, date:d(6), taskId:10, previousProgress:0, newProgress:100, note:'Cat Selesai'},
    ],
    materials: materialsDemo, 
    workers: workersDemo,
    materialLogs: [], tasks: [], attendanceLogs: [], attendanceEvidences: [] }; 
