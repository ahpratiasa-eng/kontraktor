...
const AttendanceModal: React.FC<AttendanceModalProps> = ({
    ...
    return (
        <div className="space-y-4 animate-in fade-in zoom-in duration-300">
            <h3 className="font-bold text-xl mb-4 text-slate-800">Absensi Harian</h3>
            <input
                type="date"
            ...
            <div className="bg-slate-50 p-4 rounded-xl border border-slate-200 mb-4 shadow-sm">
                ...
                <label className="w-full cursor-pointer bg-white border-2 border-dashed border-slate-300 rounded-xl h-48 flex flex-col items-center justify-center hover:bg-blue-50 hover:border-blue-300 transition-all relative overflow-hidden group">
                    {evidencePhoto ? (
                        <>
            ...
            <div className="max-h-60 overflow-y-auto space-y-2 pr-1 scrollbar-thin scrollbar-thumb-slate-300">
