...
const Header: React.FC<HeaderProps> = ({
    ...
    const handleBack = () => {
        if (view === 'project-detail' && activeTab && activeTab !== 'dashboard' && setActiveTab) {
            ...
            setView('dashboard'); // Go back to dashboard instead of project-list
        }
    };

    // Show branding on main views (dashboard, project-list)
    const isMainView = view === 'dashboard' || view === 'project-list';
